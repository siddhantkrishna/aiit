...
export default async function ApplyPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return <><Navbar/><main className="bg-background py-14 md:py-20"><div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
    <p className="text-sm font-semibold text-primary uppercase tracking-wider">Career Application</p>
    <h1 className="text-3xl md:text-4xl font-bold mt-2">Apply for {job.title}</h1>
