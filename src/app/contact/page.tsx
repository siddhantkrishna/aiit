                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted">+91 98765 43211</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      <span className="text-xl">💬</span>
              ...
              <div className="space-y-6">
                <div className="bg-primary text-white rounded-xl p-6">
                  ...
                  <p className="text-blue-100 text-sm mb-4">
                    Need help with your admission? Our team is here to assist
                    you with course selection, eligibility, and application
                    process.
                  </p>
                  <div className="space-y-3">
                    <a
                      href="tel:+919876543210"
                      className="flex items-center gap-3 bg-white/10 rounded-lg p-3 hover:bg-white/20 transition-colors"
                    >
                      <span>📞</span>
                      <div>
                        <p className="font-medium text-sm">Call Now</p>
                        <p className="text-xs text-blue-200">+91 98765 43210</p>
                      </div>
                    </a>
                    <a
                    ...
                    <a
                      href="mailto:admission@aiitcollege.edu.in"
                      className="flex items-center gap-3 bg-white/10 rounded-lg p-3 hover:bg-white/20 transition-colors"
                    >
                      <span>✉️</span>
                      <div>
                ...
                <div className="bg-white rounded-xl border border-border p-6 text-center">
                  ...
                  <p className="text-sm text-muted mb-4">
                    Start your application online. No registration required.
                  </p>
                  <a
                    href="/admission"
